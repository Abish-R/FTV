...
/**
 * Created by Harsh Goynka on 10/06/2016.
 */
public class ViewAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String categoryName = getIntent().getStringExtra("product_categoryname");
        product_id2 = getIntent().getStringExtra("product_id");
...
// toolbar
    ...
    private void requestProducts() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, UrlConstants.seeAllURL, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                Log.e("View All Response", s);
                    ...
                    if (pageNumber == 0) {
                        ...
                        for (int i = 0; i < temp.length(); i++) {
                            ...
                            for (int j = 0; j < data.length(); j++) {
                                product_id = data.getJSONObject(j).getInt("product_id");
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Snackbar.make(findViewById(R.id.view_all_container), "No internet connection", Snackbar.LENGTH_INDEFINITE)
...
//                Toast.makeText(MainActivity.this, "Please check your internet connection!", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String product_id2 = getIntent().getStringExtra("product_id");
                params.put("product_id", product_id2);
