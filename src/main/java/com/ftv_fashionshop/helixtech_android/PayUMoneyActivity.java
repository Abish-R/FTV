...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    private static final String TAG = "PAy U money";
    /**
    ...
    */
    ...
    private String mSuccessUrl = "http://httest.in/ftvws/";
    private String mFailedUrl = "http://httest.in/ftvws/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            mFirstName = AccountManager.getName(this);
            mEmailId = AccountManager.getEmail(this);
            mAmount =getIntent().getDoubleExtra("amount",0);
            if(mAmount==0){
                return;
            }
            mProductInfo=getString(R.string.app_name);
...
//                        intent.putExtra("isFromOrder", isFromOrder);
            ...
            mapParams.put("phone", "9912249068");
            ...
            /*String post_data= "hash="+mHash+"&key="+mMerchantKey+"&txnid="+mTXNId+"&amount="+String.valueOf(mAmount)+
                    "&productinfo="+mProductInfo+"&firstname="+mFirstName+
                    "&email="+mEmailId+"&phone=9912249068"+
                    "&surl="+mSuccessUrl+"&furl="+ mFailedUrl+
                    "&service_provider="+ "payu_paisa";
            webView.postUrl("https://test.payu.in/_payment", Base64.encode(post_data.getBytes(),Base64.DEFAULT));*/
        } else {
    ...
    private void onPressingBack() {
        ...
        final Intent intent;
            intent = new Intent(PayUMoneyActivity.this,
                    CartActivity.class);
